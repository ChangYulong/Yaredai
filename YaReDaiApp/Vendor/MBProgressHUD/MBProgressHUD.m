...
+ (MB_INSTANCETYPE)showTextAddedTo:(UIView *)view text:(NSString *)text
{
    MBProgressHUD *hud = [[self alloc] initWithView:view];
...
+ (MB_INSTANCETYPE)showTextWith:(UIViewController *)controller text:(NSString *)text
{
    return [MBProgressHUD showTextAddedTo:controller.navigationController.view text:text];
}
