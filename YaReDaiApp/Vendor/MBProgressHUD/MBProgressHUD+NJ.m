...
//
//@property (nonatomic, strong) MBProgressHUD *lwHud;
//
//@end

@implementation MBProgressHUD (NJ)

+ (void)showErrorLongText:(NSString *)text toView:(UIView *)view {
...
{
    [self showErrorLongText:error toView:nil];
}
...
+ (MBProgressHUD *)showMessage:(NSString *)message toView:(UIView *)view {
    ...
    hud.userInteractionEnabled = NO;//关闭hud的交互
...
+ (MBProgressHUD *)showToView:(UIView *)view {
    ...
    hud.dimBackground = NO;
    hud.userInteractionEnabled = NO;//关闭hud的交互
    [hud hide:YES afterDelay:15];//15s后自动隐藏
